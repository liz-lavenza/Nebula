/datum/level_data/player_level/kingdom_come
	use_global_exterior_ambience = FALSE
	base_area = null
	base_turf = /turf/floor/natural/dirt
	abstract_type = /datum/level_data/player_level/kingdom_come
	ambient_light_level = 1
	ambient_light_color = "#f3e6ca"
	strata = /decl/strata/kingdom_come
	exterior_atmosphere = list(
		/decl/material/gas/oxygen =   MOLES_O2STANDARD,
		/decl/material/gas/nitrogen = MOLES_N2STANDARD
	)
	daycycle_type = /datum/daycycle/kingdom_come
	daycycle_id = "daycycle_kingdom_come"
...
/datum/daycycle/kingdom_come
	cycle_duration = 2 HOURS // 1 hour of daylight, 1 hour of night

// Randomized time of day to start at.
/datum/daycycle/kingdom_come/New()
	time_in_cycle = rand(cycle_duration)
	..()

/datum/level_data/player_level/kingdom_come/get_subtemplate_areas(template_category, blacklist, whitelist)
	return submap_area ? (islist(submap_area) ? submap_area : list(submap_area)) : null

/datum/level_data/player_level/kingdom_come/get_subtemplate_budget()
	return submap_budget

/datum/level_data/player_level/kingdom_come/get_subtemplate_category()
	return submap_category

/datum/level_data/player_level/kingdom_come/after_generate_level()
	. = ..()
...
/datum/level_data/player_level/kingdom_come/town
	name = "Nordfeste - Town"
	level_id = "kingdom_come_town"
	level_generators = list(
		/datum/random_map/noise/forage
	)

/obj/abstract/level_data_spawner/kingdom_come_town
	level_data_type = /datum/level_data/player_level/kingdom_come/town